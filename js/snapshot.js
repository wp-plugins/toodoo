    ...
    $$('a[class="snapshot"]').each(function(element){
        new Ajax.Request(toodoopath + 'toodoo-wrap.php', {
          ...
          onSuccess: function(transport){
            ...
            if (json.favicon_url) favicon = '<img src="' + json.favicon_url + '" />'; else favicon = '';
            ...
            new Tip(element, html, { hideOn: { element: 'tip', event: 'mouseout'}, hideAfter: 0.5, effect: 'appear', hook: { tip: 'topLeft', target: 'bottomRight'}, offset: { x: -20, y: 5 }});
          }
        });
    });
});
